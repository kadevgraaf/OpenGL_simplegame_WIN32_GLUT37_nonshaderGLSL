...
# ADD LINK32 user32.lib glut32.lib glu32.lib opengl32.lib /nologo /subsystem:console /machine:I386
...
# ADD LINK32 user32.lib glut32.lib glu32.lib opengl32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../bin/project.exe" /pdbtype:sept /libpath:".."
